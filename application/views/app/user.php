                        ...
                        <div class="card-box table-responsive">
                            ...
                            <table id="user" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<button class="btn btn-warning" onclick="update_user(<?php echo $row->id;?>)"><i class="fa fa-pencil"></i></button>
																			<button class="btn btn-danger" onclick="delete_user(<?php echo $row->id;?>)"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
                                <?php } ?>
                                </tbody>
